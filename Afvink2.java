...
public class Afvink2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        SecretCheckbox = new javax.swing.JCheckBox();
        ...
        SecretCheckbox.setText("?");
        SecretCheckbox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SecretCheckboxActionPerformed(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(SecretCheckbox, javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void PrintMolButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PrintMolButtonActionPerformed
        ...
        //if(!NoError){X_pos = X_cache;Y_pos = Y_cache;}
        // <editor-fold defaultstate="collapsed" desc="">
        if(SecretOption){
            int RandomXValue = randomGenerator.nextInt(300)+30;
            int RandomYValue = randomGenerator.nextInt(300)+30;
            
            X_pos = randomGenerator.nextInt(300)+30;
            Y_pos = randomGenerator.nextInt(300)+30;
            
            PrintMolButton.setLocation(RandomXValue, RandomYValue);
            PrintPane.add(PrintMolButton);
        }
        // </editor-fold>
        ...
        circle_1.fillOval(X_pos-25,Y_pos+25,25,25);
        circle_2.fillOval(X_pos-25,Y_pos-50, 25, 25);
        circle_3.fillOval(X_pos+15, Y_pos-20, 40, 40);
        
        circle_1.drawOval(X_pos-25,Y_pos+25,25,25);
        circle_2.drawOval(X_pos-25,Y_pos-50, 25, 25);
        circle_3.drawOval(X_pos+15, Y_pos-20, 40, 40);
        
        line_1.drawLine(X_pos-12, Y_pos+25, X_pos+15, Y_pos);
        line_2.drawLine(X_pos-12,Y_pos-25, X_pos+15, Y_pos);
        // </editor-fold>
...
// Extra functies    
    ...
    private void SecretCheckboxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SecretCheckboxActionPerformed
        SecretCheckbox.addItemListener(new ItemListener() {
            @Override
            public void itemStateChanged(ItemEvent e) {
                if(e.getStateChange() == ItemEvent.SELECTED) {//checkbox has been selected
                    SecretOption = true;
                    SecretCheckbox.setFont(SecretCheckbox.getFont().deriveFont(Font.BOLD));
                } else {//checkbox has been deselected
                    SecretOption = false;
                    SecretCheckbox.setFont(SecretCheckbox.getFont().deriveFont(Font.PLAIN));
                };
            }
        });
    }//GEN-LAST:event_SecretCheckboxActionPerformed
    ...
    private javax.swing.JCheckBox SecretCheckbox;
